...
object TestDataCleanupHelper {
     ...
     */
    fun cleanupRedis(redisTemplate: RedisTemplate<String, Any>) {
        try {
     ...
     */
    fun cleanupAll(redisTemplate: RedisTemplate<String, Any>, jdbcTemplate: JdbcTemplate) {
     ...
     */
    fun cleanupAllWithSequenceReset(redisTemplate: RedisTemplate<String, Any>, jdbcTemplate: JdbcTemplate) {
        cleanupRedis(redisTemplate)
        cleanupDatabase(jdbcTemplate)
