...
-- -----------------------------------------------------------------------------
-- 10. 결제 상태 타입 (중복 체크 후 삽입)
-- -----------------------------------------------------------------------------
INSERT INTO payment_status_type (code, name, description, is_active, created_at)
SELECT 'PEND', '결제 대기', '결제 요청이 처리 대기 중인 상태입니다.', true, NOW()
WHERE NOT EXISTS (SELECT 1 FROM payment_status_type WHERE code = 'PEND');

INSERT INTO payment_status_type (code, name, description, is_active, created_at)
SELECT 'COMP', '결제 완료', '결제가 성공적으로 완료된 상태입니다.', true, NOW()
WHERE NOT EXISTS (SELECT 1 FROM payment_status_type WHERE code = 'COMP');

INSERT INTO payment_status_type (code, name, description, is_active, created_at)
SELECT 'FAIL', '결제 실패', '결제 처리 중 오류가 발생한 상태입니다.', true, NOW()
WHERE NOT EXISTS (SELECT 1 FROM payment_status_type WHERE code = 'FAIL');

INSERT INTO payment_status_type (code, name, description, is_active, created_at)
SELECT 'CANC', '결제 취소', '사용자 또는 시스템에 의해 취소된 상태입니다.', true, NOW()
WHERE NOT EXISTS (SELECT 1 FROM payment_status_type WHERE code = 'CANC');

INSERT INTO payment_status_type (code, name, description, is_active, created_at)
SELECT 'REFD', '결제 환불', '결제가 환불 처리된 상태입니다.', true, NOW()
WHERE NOT EXISTS (SELECT 1 FROM payment_status_type WHERE code = 'REFD');
...
(1, 1, (SELECT id FROM seat WHERE schedule_id = 3 AND seat_number = 'VIP01' LIMIT 1), 1, 'VIP01', 250000.00, 'CONFIRMED', NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY),
(1, 1, (SELECT id FROM seat WHERE schedule_id = 3 AND seat_number = 'VIP02' LIMIT 1), 1, 'VIP02', 250000.00, 'CONFIRMED', NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY),
(2, 2, (SELECT id FROM seat WHERE schedule_id = 3 AND seat_number = 'VIP03' LIMIT 1), 2, 'VIP03', 250000.00, 'CONFIRMED', NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 2 DAY),
(2, 2, (SELECT id FROM seat WHERE schedule_id = 3 AND seat_number = 'R01' LIMIT 1), 2, 'R01', 200000.00, 'CONFIRMED', NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 2 DAY);
